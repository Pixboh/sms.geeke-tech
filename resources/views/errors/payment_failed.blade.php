...
@section('title', __('locale.labels.payment_failed_title'))
@section('code', '200')
    ...
    <div class="misc-wrapper">
        ...
        <div class="misc-inner p-2 p-sm-3">
            <div class="w-100 text-center">
                <h2 class="mb-1">{{__('locale.labels.payment_failed_title')}}</h2>
                <p class="mb-2">{{ __('locale.labels.payment_failed_message') }}</p>
