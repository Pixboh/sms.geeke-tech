<div id="datatables-basic">
    ...
    <div class="mb-3 mt-2">
        ...
        @can('create_contact')
            <div id="add_new_contact" class="btn-group">
                <a href="{{route('customer.contact.create', $contact->uid)}}"
                   class="btn btn-success waves-light waves-effect fw-bold me-1"> {{__('locale.buttons.add_new_contact')}} <i
                            data-feather="plus-circle"></i></a>
            </div>
        @endcan

        @can('view_contact')
            <div id="import" class="btn-group">
