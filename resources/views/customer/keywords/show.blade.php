                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="title" class="form-control" value="{{ $keyword->title }}" @if(auth()->user()->can('create_keywords')) required @else readonly @endif>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" id="keyword_name" class="form-control" value="{{ $keyword->keyword_name}}"
                                                       @if(auth()->user()->can('create_keywords')) required @else readonly @endif>
                                            </div>
                                        </div>
